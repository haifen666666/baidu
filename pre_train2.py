...
def put_time_tag():
    visit = pd.read_hdf('visit_hour.h5')
    visit = visit.iloc[50000000:,:] #分两次操作  前5000万条  和后面的
    ...
    visit.to_hdf('visit_hour22.h5',mode='w',key='tt',complevel=6,complib='blosc') #这里需要区分两次的文件，然后在终端合并
...
def get_train_features():
    ...
    for area_id,area in visit_area:
        ...
        index += 1
        answer = area.iloc[1,:].func_id #拿到答案，属于那个功能区域
